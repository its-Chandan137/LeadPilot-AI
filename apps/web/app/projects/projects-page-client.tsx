  ...
  return (
    <>
      <div className="flex items-center justify-between">
        ...
        <button
          className="rounded-lg bg-violet-600 px-4 py-2 text-sm text-white hover:bg-violet-700 transition-colors flex items-center gap-1.5"
      ...
      {projects.length === 0 ? (
        <div className="mt-8 flex flex-col items-center justify-center rounded-xl border border-dashed border-slate-300 bg-slate-50 py-16 px-4">
          ...
          <button
            className="rounded-lg bg-violet-600 px-4 py-2 text-sm text-white hover:bg-violet-700 transition-colors"
            onClick={() => setDialogOpen(true)}
          >
            Create Project
          </button>
              ...
              <div className="flex items-start justify-between gap-4 p-5 pl-6">
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-2">
                    ...
                    <span className="text-sm text-slate-500">Bot: {project.config.botName}</span>
                  </div>
                </div>
      ...
      <CreateProjectDialog open={dialogOpen} onOpenChange={handleOpenChange} />
    </>
  );
}
